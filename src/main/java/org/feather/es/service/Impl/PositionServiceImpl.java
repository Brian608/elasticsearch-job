package org.feather.es.service.Impl;
...
import org.feather.es.utils.DBHelper;
...
public class PositionServiceImpl implements PositionService {
    ...
    @Override
    public List<Map<String, Object>> searchPos(String keyWords, int pageNo, int pageSize) throws IOException {
        if (pageNo<=1){
            pageNo=1;
        }
        ...
        QueryBuilder queryBuilder=QueryBuilders.matchQuery("positionName",keyWords);
